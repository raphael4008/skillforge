...
(7, 'ORDS57717951', 'jay@skillforge.com', 14, 'TXN_SUCCESS', 'Txn Success', 400, '2019-09-13'),
(8, 'ORDS22968322', 'mario@skillforge.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, '2019-09-13'),
(9, 'ORDS78666589', 'ignou@skillforge.com', 10, 'TXN_SUCCESS', 'Txn Success', 800, '2019-09-19'),
...
(3, 'My life at skillforge made me stronger and took me a step ahead for being an independent women. I am thankful to all the teachers who supported us and corrected us throughout our career. I am very grateful to the skillforge for providing us the best of placement opportunities and finally I got placed in DC Marvel.', 171),
(8, 'I am grateful to skillforge - both the faculty and the Training & Placement Department. They have made efforts ensuring maximum number of placed students. Due to the efforts made by the faculty and placement cell. I was able to bag a job in the second company.', 172),
(9, 'skillforge is a place of learning, fun, culture, lore, literature and many such life preaching activities. Studying at the skillforge brought an added value to my life.', 173),
(10, 'Think Magical, that is one thing that skillforge urges in and to far extent succeed in teaching to its students which invariably helps to achieve what you need.', 174),
...
(176, ' Shaktiman', 'shaktiman@skillforge.com', '123456', 'Software ENgg', '../image/stu/shaktiman.jpg'),
(178, ' Mario', 'mario@skillforge.com', '1234567', ' Web Dev', '../image/stu/super-mario-2690254_1280.jpg'),
